...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p>Danh mục</p>
         <div class="flex-box">
            <a href="category.php?category=nature" class="links">Nước Hoa</a>
            <a href="category.php?category=education" class="links">Kem nền</a>
            <a href="category.php?category=business" class="links">Son môi</a>
            <a href="category.php?category=travel" class="links">Mascara</a>
            <a href="category.php?category=news" class="links">Phấn mắt</a>
            <a href="category.php?category=gaming" class="links">Phấn má hồng</a>
            <a href="category.php?category=sports" class="links">Phấn phủ</a>
            <a href="category.php?category=design" class="links">Sữa rửa mặt</a>
            <a href="category.php?category=fashion" class="links">Dầu gội</a>
            <a href="category.php?category=persional" class="links">Sơn móng tay</a>
            <a href="all_category.php" class="btn">Hiển thị thêm</a>
         </div>
      </div>
      ...
      <div class="box">
         ...
         ?>  
         <a href="authors.php" class="btn">Hiển thị tất cả</a>
         <a href="/projectN2/admin_phu/admin_login.php" class="btn">Đăng bài</a>
         <a href="nap_tien.php" class="btn">nạp tiền</a>
         </div>
      </div>
